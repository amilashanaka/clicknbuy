...
if( $log->get_all()['error']==null){$list = $log->get_all()['data'];}else{$list =null;}
                    ...
                    <?php if ($_SESSION['role'] >5) { ?>
                        <div class="card-header">
                            <h3 class="card-title">
                                <div class="row">
                                    <div class="col6">
                                        <button type="button" class="btn btn-app" onclick="location.href = 'log'"><i class="fas fa-file"></i><?= $lang['Add New'] ?></button>
                                    </div>
                                </div>
                            </h3>
                        </div>
