...
$form_config = $Todo_category_page_elements;


if (isset($_GET['id'])) {
    $id = base64_decode($_GET['id']);
    $row = $todo_categories->get_by_id($id)['data'];
} else {
    $id = 0;
    $row = null;
}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="button" style="width: 20%;" value="Browse" id="browse_icon" class="btn btn-block btn-success" />
                                                </div>
