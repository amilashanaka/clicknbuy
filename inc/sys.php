...
array_push($side_menu, array( 'name' => 'Products', 'icon' => 'fas fa-hamburger', 'url' => '#', 'active' => '' , 'menu'=>'','submenu' => array( array('name' => 'Allergies', 'icon' => 'fas fa-list', 'url' => 'allergies_list'), array('name' => 'Client Allergis', 'icon' => 'fas fa-list', 'url' => 'client_allergies_list')) ));
