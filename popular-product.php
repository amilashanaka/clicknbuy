                                ...
                                <div class="row top-row">
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                        <div class="product-item ver2">
                                            <div class="prod-item-img bd-style-2">
                                                <a href="#"><img src="img/products/popular1.avif" style="width:200px; height:200px" alt="images" class="img-responsive"></a>
                                                <div class="button">
                                            ...
                                            <div class="prod-info">
                                                <h3><a href="#"> Tesco Finest Baby Spinach (100g)</a></h3>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding-right">
                                        <div class="product-item ver2">
                                            ...
                                            <div class="prod-info">
                                                <h3><a href="#"> Sainsbury's Spaghetti (500g)</a></h3>
                                                <div class="ratingstar sm">
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                ...
                                                <div class="p-price">
                                                    <span class="price black">£1.00</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding-right">
                                        <div class="product-item ver2">
                                            ...
                                            <div class="prod-info">
                                                <h3><a href="#"> Iceland Frozen Peas (500g)</a></h3>
                                                <div class="ratingstar sm">
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                ...
                                                <div class="p-price">
                                                    <span class="price black">£0.75</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding-right">
                                        <div class="product-item ver2">
                                            <div class="prod-item-img bd-style-2">
                                                <a href="#"><img src="img/products/popular4.avif" style="width:200px; height:200px" alt="images" class="img-responsive"></a>
                                                <div class="button">
                                                    <a href="#" class="addcart addcart-v2">ADD TO CART</a>
                                                    <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                </div>
                                            ...
                                            <div class="prod-info">
                                                <h3><a href="#">Tesco Semi-Skimmed Milk (4 pints)</a></h3>
                                                <div class="ratingstar sm">
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding-right">
                                        <div class="product-item ver2">
                                            <div class="prod-item-img bd-style-2">
                                                <a href="#"><img src="img/products/popular5.jpeg" style="width:200px; height:200px" alt="images" class="img-responsive"></a>
                                                <div class="button">
                                                    <a href="#" class="addcart addcart-v2">ADD TO CART</a>
                                                    <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                </div>
                                            ...
                                            <div class="prod-info">
                                                <h3><a href="#">Heinz Tomato Ketchup (570g)</a></h3>
                                                <div class="ratingstar sm">
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding-right">
                                        <div class="product-item ver2">
                                            <div class="prod-item-img bd-style-2">
                                                <a href="#"><img src="img/products/popular6.jpeg" style="width:200px; height:200px" alt="images" class="img-responsive"></a>
                                                <div class="button">
                                                    <a href="#" class="addcart addcart-v2">ADD TO CART</a>
                                                    <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                </div>
                                            ...
                                            <div class="prod-info">
                                                <h3><a href="#"> Birds Eye Chicken Nuggets (300g)</a></h3>
                                                <div class="ratingstar sm">
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-star-o fa-1" aria-hidden="true"></i></a>
                                                ...
                                                <div class="p-price">
                                                    <span class="price black">£2.50</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <aside class="widget brand-v1">
                        ...
                        <div class="brand-list-v1">
                            <div class="product-item ver1 bd-style">
                                <div class="prod-item-img">
                                    <a href="#"><img src="img/products/popular1.avif" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="prod-info">
                                    <h3><a href="#">Heinz Tomato Ketchup (570g).</a></h3>
                                    <div class="p-price">
                                        <span class="price black">£1.50</span>
                                    </div>
                                </div>
                            </div>
                            <div class="product-item ver1 bd-style">
                                <div class="prod-item-img">
                                    <a href="#"><img src="img/products/onsale2.jpg" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="prod-info">
                                    <h3><a href="#">Walkers Crisps (Multipack).</a></h3>
                                    <div class="p-price">
                            ...
                            <div class="product-item ver1">
                                <div class="prod-item-img">
                                    <a href="#"><img src="img/products/popular4.avif" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="prod-info">
                                    <h3><a href="#">Tesco Semi-Skimmed Milk (4 pints)</a></h3>
                                    <div class="p-price">
                        ...
                        <div class="brand-list-v1">
                            <div class="product-item ver1 bd-style">
                                <div class="prod-item-img">
                                    <a href="#"><img src="img/products/brand4.jpg" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="prod-info">
                                    <h3><a href="#">Kellogg's Coco Pops (375g)</a></h3>
                                    <div class="p-price">
                            ...
                            <div class="product-item ver1 bd-style">
                                <div class="prod-item-img">
                                    <a href="#"><img src="img/products/brand5.png" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="prod-info">
                                    <h3><a href="#">Coca-Cola (2 Litre)</a></h3>
                                    <div class="p-price">
                                        <span class="price black">£1.20</span>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="product-item ver1">
